package com.kitzapp.telegram_stats.clean_mvp.domain.interactors;

import com.kitzapp.telegram_stats.clean_mvp.domain.executor.Executor;
import com.kitzapp.telegram_stats.clean_mvp.domain.executor.ThreadExecutor;
import com.kitzapp.telegram_stats.clean_mvp.domain.threading.MainThread;
import com.kitzapp.telegram_stats.clean_mvp.domain.threading.Thread;
...
public abstract class AbstractInteractor implements Interactor {
    ...
    protected Executor _threadExecutor;
    ...
    public AbstractInteractor() {
        _threadExecutor = ThreadExecutor.getInstance();
        _mainThread = MainThread.getInstance();
    }
